 ...
 * Contiene todos los datos capturados en el formulario de inversión
 */
data class InversionRequest(
    @SerializedName("tipo_reporte")
    val tipoReporte: String = "inversion",
...
data class AdjuntosRequest(
    ...
    val fotosInicio: List<String>, // base64 de las imágenes

    @SerializedName("fotos_fin")
    val fotosFin: List<String> //  base64 de las imágenes
)
